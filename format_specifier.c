...
int main()
{
    ...
    // long, long long 정수
    printf("%lu\n", 4294967295);            // 4294967295: 부호 없는 long
    printf("%ld\n", 2147483647);            // 2147483647: 부호 있는 long
    printf("%llu\n", 18446744073709551615); // 18446744073709551615: 부호 없는 long long
    printf("%lld\n", 9223372036854775807);  // 9223372036854775807: 부호 있는 long long
    ...
    printf("%Lf", 1.797693e+308); // 생략: long double
    printf("%Le", 1.797693e+308); // 1.797693e+308: long double
